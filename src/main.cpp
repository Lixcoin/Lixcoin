...
#if defined(NDEBUG)
# error "Lixcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Lixcoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Lixcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Lixcoin also requires low S in sigs
