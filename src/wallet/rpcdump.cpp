...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"lixcoinaddress\"\n"
            "\nReveals the private key corresponding to 'lixcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"lixcoinaddress\"   (string, required) The lixcoin address for the private key\n"
            "\nResult:\n"
