...
const QString BITCOIN_IPC_PREFIX("lixcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/lixcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lixcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lixcoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click lixcoin: links
...
//
// OSX-specific way of handling lixcoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in lixcoin: URIs
