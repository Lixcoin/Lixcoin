...
These are the dependencies currently used by Lixcoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/lixcoinnl
Keybase  - https://keybase.io/team/lixcoin/
